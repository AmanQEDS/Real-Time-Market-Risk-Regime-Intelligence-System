...
# installed.
TCL_PREFIX='A:/Real-Time Market Risk & Regime Intelligence System/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='A:/Real-Time Market Risk & Regime Intelligence System/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='A:/Real-Time Market Risk & Regime Intelligence System/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IA:/Real-Time Market Risk & Regime Intelligence System/venv\Library\include'
...
TCL_PACKAGE_PATH='A:/Real-Time Market Risk & Regime Intelligence System/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LA:/Real-Time Market Risk & Regime Intelligence System/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='A:/Real-Time Market Risk & Regime Intelligence System/venv\Library\lib\tclstub86.lib'
